window.onload = function () {
	...
	fm.onsubmit = function () {
		...
		// A function for confirming with super admin when trying 
		// to update the profile of a specific user.
		if (!confirm('Are you sure you want to update the profile of this user?')) {
			return false;
		}
